...
export default function CountdownPage(){
  ...
  return <div className={`page-root ${released?'is-released':''}`} data-phase={phase.number} style={{'--phase-progress':progress} as React.CSSProperties}>
    ...
    <footer>Unofficial fan-made countdown. Not affiliated with or endorsed by Marvel Studios or Disney. Character and film names belong to their respective owners.</footer></main>{released&&<ReleaseAnimation/>}
  </div>
}
